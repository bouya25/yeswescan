...
if(navigator.geolocation) {
    navigator.geolocation.getCurrentPosition(position => {
        ...
        alert(`Active la géolocalisation si tu veux savoir le temps qu'il fait chez toi !`)
    })
}
...
// pouet pouet j'ai le cerveau qui fond fond j'ai le cerveau qui fond fond, voila il a fondu !
